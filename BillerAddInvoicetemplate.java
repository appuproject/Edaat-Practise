...
public class BillerAddInvoicetemplate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddInvoicesTemplates";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAddInvoicetemplate(Map<Object, Object> testdatamap){
	    	this.testdatamap=testdatamap;
	        this.TestScriptID=testdatamap.get("TestScriptID").toString();
	        this.sBrowserTestData=testdatamap.get("Browser").toString();
	        this.TemplateArabic=testdatamap.get("TemplateArabic").toString();
	        this.TemplateEnglish=testdatamap.get("TemplateEnglish").toString();
	        this.InvoiceType=testdatamap.get("InvoiceType").toString();
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Add Invoice Template is Suceessful");
	        	Pages.BillerSettingsPage.AddInvoicetemplate(TemplateArabic,TemplateEnglish,InvoiceType);
